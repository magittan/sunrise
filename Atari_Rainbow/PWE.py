...
class _PredictionWeightedEnsembler:
    ...
    def predict(self):
        """Performs prediction by selecting an index to use for prediction based
        on the weights of the Ensembler.
        ...
        """
        prediction = np.random.choice(np.arange(self.n_estimators), p=self.weights)
